...
function pictures (apiData) {
    ...
    if (apiData === 'clear-day') {
        picLink = 'https://image.ibb.co/nu6B2v/sunny.jpg';
    } else if (apiData === 'clear-night') {
        picLink = 'https://image.ibb.co/mqWN9a/clear_night.jpg';
    } else if (apiData === 'partly-cloudy-day') {
        picLink = 'https://image.ibb.co/kkFh9a/mostly_cloudy.jpg';
    } else if (apiData === 'partly-cloudy-night') {
        picLink = 'https://image.ibb.co/bE829a/cloudy_night.jpg';
    } else if (apiData === 'cloudy') {
        picLink = 'https://image.ibb.co/jFvFUa/cloudy.jpg';
    } else if (apiData === 'rain') {
        picLink = 'https://image.ibb.co/jikh9a/rain.jpg';
    } else if (apiData === 'sleet') {
        picLink = 'https://image.ibb.co/druaUa/sleet.jpg';
    } else if (apiData === 'snow') {
        picLink = 'https://image.ibb.co/haRppa/snow.jpg';
    } else if (apiData === 'wind') {
        picLink = 'https://image.ibb.co/dtCUpa/wind.jpg';
    } else if (apiData === 'fog') {
        picLink = 'https://image.ibb.co/f2q4Nv/fog.jpg';
    }
